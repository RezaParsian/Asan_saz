        ...
        <div class="card-body">
            ...
            <form class="col-md" method="POST" action="{{ route('orders.update', $order->id) }}">
                ...
                <div class="form-group row">
                    <div class="col-md">
                        <label>تعداد</label>
                        <input type="number" name="count" class="form-control text-center" value="{{ $order->count }}" min="1">
                    </div>
                    <div class="col-md">
                        <label>قیمت کل</label>
                        <input type="text" name="sumprice" class="form-control text-center" value="{{ $order->sumprice }}" min="1">
                    </div>
                </div>
